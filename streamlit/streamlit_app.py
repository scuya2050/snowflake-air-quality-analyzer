# =====================================================
# Air Quality Analytics - Main Streamlit App
# Purpose: Homepage for multi-page Snowflake Streamlit app
...
- Interactive filters: Country → City → Date
- Visualize hourly changes in PM2.5, PM10, CO, NO2, O3, SO2

#### 📍 **District Detail** (Page 3)
- Deep dive into **specific district measurements**
- Hourly trends with multiple chart types
- Geographic location on interactive map
- Filters: Country → City → District → Date

#### 🗺️ **Live Map View** (Page 4)
- Real-time **geographic visualization** of AQI levels
- Bubble size represents pollution intensity
- See current air quality across all monitored districts
...
1. **Select a dashboard** from the sidebar (Pages 1-4)
...
- Review data pipeline logs in Snowflake
